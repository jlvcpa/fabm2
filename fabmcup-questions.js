...
<div class="slide" id="slide-sAeAq02" data-question-id="sAeAq02" data-type="Theory" data-set="Set A" data-difficulty="Easy" data-topic="Branches of Accounting" data-answer="C" data-points="3">
    ...
    <div class="book-content">
        ...
        <ul style="list-style: none; padding: 0;">
            <li class="book-book-mcq-option" onclick="selectOption('sAeAq02', 'A')">A) Management Accounting</li>
            <li class="book-book-mcq-option" onclick="selectOption('sAeAq02', 'B')">B) Tax Accounting</li>
            <li class="book-book-mcq-option" onclick="selectOption('sAeAq02', 'C')">C) Financial Accounting</li>
            <li class="book-book-mcq-option" onclick="selectOption('sAeAq02', 'D')">D) Cost Accounting</li>
        </ul>
...
<div class="slide" id="slide-sCeAq01" data-question-id="sCeAq01" data-type="Theory" data-set="Set C" data-difficulty="Easy" data-topic="Introduction to Accounting" data-answer="A" data-points="3">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Introduction to Accounting</h2>
        <div class="book-content-question">Which of the following best describes the nature of accounting?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sCeAq01', 'A')">A) It is a service activity intended to provide quantitative information.</li>
            <li class="book-mcq-option" onclick="selectOption('sCeAq01', 'B')">B) It is a strictly mathematical science with no human judgment.</li>
...
<div class="slide" id="slide-sCeAq02" data-question-id="sCeAq02" data-type="Theory" data-set="Set C" data-difficulty="Easy" data-topic="Branches of Accounting" data-answer="D" data-points="3">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Branches of Accounting</h2>
        <div class="book-content-question">Which branch of accounting involves the collection and use of information specifically to assist company executives in planning and control?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sCeAq02', 'A')">A) Financial Accounting</li>
            <li class="book-mcq-option" onclick="selectOption('sCeAq02', 'B')">B) Auditing</li>
...
<div class="slide" id="slide-sCeAq03" data-question-id="sCeAq03" data-type="Theory" data-set="Set C" data-difficulty="Easy" data-topic="Users of Accounting Information" data-answer="B" data-points="3">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Users of Accounting Information</h2>
        <div class="book-content-question">Which of the following is considered an external user who needs accounting information to decide whether to buy, hold, or sell shares of a company?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sCeAq03', 'A')">A) Production Supervisor</li>
            <li class="book-mcq-option" onclick="selectOption('sCeAq03', 'B')">B) Potential Investors</li>
...
<div class="slide" id="slide-sCeAq04" data-question-id="sCeAq04" data-type="Theory" data-set="Set C" data-difficulty="Easy" data-topic="Forms of Business Organizations" data-answer="C" data-points="3">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Forms of Business Organizations</h2>
        <div class="book-content-question">Which type of business organization is considered a legal entity that is separate and distinct from its owners, and its ownership is divided into shares?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sCeAq04', 'A')">A) Sole Proprietorship</li>
            <li class="book-mcq-option" onclick="selectOption('sCeAq04', 'B')">B) Partnership</li>
...
<div class="slide" id="slide-sCeAq05" data-question-id="sCeAq05" data-type="Theory" data-set="Set C" data-difficulty="Easy" data-topic="Accounting Concepts and Principles" data-answer="A" data-points="3">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Accounting Concepts and Principles</h2>
        <div class="book-content-question">Which concept requires that accounting records be based on the most reliable and unbiased evidence available?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sCeAq05', 'A')">A) Objectivity Principle</li>
            <li class="book-mcq-option" onclick="selectOption('sCeAq05', 'B')">B) Materiality Concept</li>
...
<div class="slide" id="slide-sCeAq06" data-question-id="sCeAq06" data-type="Theory" data-set="Set C" data-difficulty="Easy" data-topic="The Accounting Equation and Major Accounts" data-answer="B" data-points="3">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: The Accounting Equation and Major Accounts</h2>
        <div class="book-content-question">Which of the following is classified as a Liability?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sCeAq06', 'A')">A) Accounts Receivable</li>
            <li class="book-mcq-option" onclick="selectOption('sCeAq06', 'B')">B) Notes Payable</li>
...
<div class="slide" id="slide-sCeAq07" data-question-id="sCeAq07" data-type="Theory" data-set="Set C" data-difficulty="Easy" data-topic="Books of Accounts" data-answer="D" data-points="3">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Books of Accounts</h2>
        <div class="book-content-question">Which of the following is used to group and summarize all transactions affecting a specific account?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sCeAq07', 'A')">A) General Journal</li>
            <li class="book-mcq-option" onclick="selectOption('sCeAq07', 'B')">B) Special Journal</li>
...
<div class="slide" id="slide-sCeAq08" data-question-id="sCeAq08" data-type="Problem Solving" data-set="Set C" data-difficulty="Easy" data-topic="Books of Accounts" data-answer="B" data-points="3">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Books of Accounts</h2>
        <div class="book-content-question">A company has a beginning balance in the Cash account of ₱10,000. During the day, it records a debit of ₱5,000 and a credit of ₱2,000. What is the ending balance of the Cash account?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sCeAq08', 'A')">A) ₱17,000</li>
            <li class="book-mcq-option" onclick="selectOption('sCeAq08', 'B')">B) ₱13,000</li>
...
<div class="slide" id="slide-sCeAq09" data-question-id="sCeAq09" data-type="Problem Solving" data-set="Set C" data-difficulty="Easy" data-topic="Accounting Cycle (Service)" data-answer="C" data-points="3">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Accounting Cycle (Service)</h2>
        <div class="book-content-question">A laundry shop paid ₱12,000 for a 1-year insurance policy on January 1. On January 31, how much Insurance Expense should be recorded as an adjusting entry?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sCeAq09', 'A')">A) ₱12,000</li>
            <li class="book-mcq-option" onclick="selectOption('sCeAq09', 'B')">B) ₱11,000</li>
...
<div class="slide" id="slide-sCeAq10" data-question-id="sCeAq10" data-type="Problem Solving" data-set="Set C" data-difficulty="Easy" data-topic="Accounting Cycle (Merchandising)" data-answer="A" data-points="3">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Accounting Cycle (Merchandising)</h2>
        <div class="book-content-question">A retailer bought 10 shirts for ₱200 each and sold all of them for ₱500 each. What is the Gross Profit?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sCeAq10', 'A')">A) ₱3,000</li>
            <li class="book-mcq-option" onclick="selectOption('sCeAq10', 'B')">B) ₱5,000</li>
...
<div class="slide" id="slide-sDeAq01" data-question-id="sDeAq01" data-type="Theory" data-set="Set D" data-difficulty="Easy" data-topic="Introduction to Accounting" data-answer="C" data-points="3">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Introduction to Accounting</h2>
        <div class="book-content-question">Which organization defined accounting as "the process of identifying, measuring, and communicating economic information to permit informed judgments and decisions by users"?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sDeAq01', 'A')">A) AICPA</li>
            <li class="book-mcq-option" onclick="selectOption('sDeAq01', 'B')">B) ASC</li>
...
<div class="slide" id="slide-sDeAq02" data-question-id="sDeAq02" data-type="Theory" data-set="Set D" data-difficulty="Easy" data-topic="Branches of Accounting" data-answer="B" data-points="3">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Branches of Accounting</h2>
        <div class="book-content-question">Which branch of accounting is primarily responsible for ensuring that financial statements are prepared in accordance with Generally Accepted Accounting Principles (GAAP)?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sDeAq02', 'A')">A) Cost Accounting</li>
            <li class="book-mcq-option" onclick="selectOption('sDeAq02', 'B')">B) Financial Accounting</li>
...
<div class="slide" id="slide-sDeAq03" data-question-id="sDeAq03" data-type="Theory" data-set="Set D" data-difficulty="Easy" data-topic="Users of Accounting Information" data-answer="B" data-points="3">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Users of Accounting Information</h2>
        <div class="book-content-question">Which group of external users is primarily interested in financial information to determine if a company can provide consistent dividends and growth?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sDeAq03', 'A')">A) Creditors</li>
            <li class="book-mcq-option" onclick="selectOption('sDeAq03', 'B')">B) Investors (Stockholders)</li>
...
<div class="slide" id="slide-sDeAq04" data-question-id="sDeAq04" data-type="Theory" data-set="Set D" data-difficulty="Easy" data-topic="Forms of Business Organizations" data-answer="D" data-points="3">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Forms of Business Organizations</h2>
        <div class="book-content-question">Which form of business organization provides its owners (stockholders) with the benefit of "limited liability"?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sDeAq04', 'A')">A) General Partnership</li>
            <li class="book-mcq-option" onclick="selectOption('sDeAq04', 'B')">B) Sole Proprietorship</li>
...
<div class="slide" id="slide-sDeAq05" data-question-id="sDeAq05" data-type="Theory" data-set="Set D" data-difficulty="Easy" data-topic="Accounting Concepts and Principles" data-answer="B" data-points="3">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Accounting Concepts and Principles</h2>
        <div class="book-content-question">Which accounting principle states that the life of a business can be divided into equal time intervals, such as a month or a year, for reporting purposes?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sDeAq05', 'A')">A) Going Concern</li>
            <li class="book-mcq-option" onclick="selectOption('sDeAq05', 'B')">B) Periodicity (Time Period) Concept</li>
...
<div class="slide" id="slide-sDeAq06" data-question-id="sDeAq06" data-type="Theory" data-set="Set D" data-difficulty="Easy" data-topic="The Accounting Equation and Types of Major Accounts" data-answer="B" data-points="3">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: The Accounting Equation and Major Accounts</h2>
        <div class="book-content-question">Which of the following accounts is considered an Asset?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sDeAq06', 'A')">A) Unearned Revenue</li>
            <li class="book-mcq-option" onclick="selectOption('sDeAq06', 'B')">B) Accounts Receivable</li>
...
<div class="slide" id="slide-sDeAq07" data-question-id="sDeAq07" data-type="Theory" data-set="Set D" data-difficulty="Easy" data-topic="Books of Accounts" data-answer="A" data-points="3">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Books of Accounts</h2>
        <div class="book-content-question">What is the "General Journal" often called because it is the first place where a transaction is recorded?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sDeAq07', 'A')">A) Book of Original Entry</li>
            <li class="book-mcq-option" onclick="selectOption('sDeAq07', 'B')">B) Book of Final Entry</li>
...
<div class="slide" id="slide-sDeAq08" data-question-id="sDeAq08" data-type="Problem Solving" data-set="Set D" data-difficulty="Easy" data-topic="Books of Accounts" data-answer="8000" data-points="3">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Books of Accounts</h2>
        <div class="book-content-question">The Cash account has a beginning debit balance of ₱10,000. During the month, total debits were ₱5,000 and total credits were ₱7,000. What is the ending balance? (Enter numbers only)</div>
        <input type="number" class="input-field" id="input-sDeAq08" placeholder="Enter amount...">
        <button class="submit-btn" id="submit-sDeAq08" onclick="submitAnswer('sDeAq08')">Submit Answer</button>
        <button class="exp-btn" id="exp-sDeAq08" onclick="toggleBookMode()">Show Explanation</button>
        <div class="quiz-feedback" id="feedback-sDeAq08"></div>
...
<div class="slide" id="slide-sEeAq01" data-question-id="sEeAq01" data-type="Theory" data-set="Set E" data-difficulty="Easy" data-topic="Introduction to Accounting" data-answer="C" data-points="3">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Introduction to Accounting</h2>
        <div class="book-content-question">What is the primary purpose of accounting?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sEeAq01', 'A')">A) To calculate taxes only</li>
            <li class="book-mcq-option" onclick="selectOption('sEeAq01', 'B')">B) To record all human resource complaints</li>
...
<div class="slide" id="slide-sEeAq02" data-question-id="sEeAq02" data-type="Theory" data-set="Set E" data-difficulty="Easy" data-topic="Branches of Accounting" data-answer="C" data-points="3">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Branches of Accounting</h2>
        <div class="book-content-question">Which branch of accounting primarily involves the preparation of tax returns and compliance with tax laws?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sEeAq02', 'A')">A) Auditing</li>
            <li class="book-mcq-option" onclick="selectOption('sEeAq02', 'B')">B) Cost Accounting</li>
...
<div class="slide" id="slide-sEeAq03" data-question-id="sEeAq03" data-type="Theory" data-set="Set E" data-difficulty="Easy" data-topic="Users of Accounting Information" data-answer="B" data-points="3">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Users of Accounting Information</h2>
        <div class="book-content-question">Which of the following is considered an internal user of accounting information?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sEeAq03', 'A')">A) Stockholders</li>
            <li class="book-mcq-option" onclick="selectOption('sEeAq03', 'B')">B) Board of Directors</li>
...
<div class="slide" id="slide-sEeAq04" data-question-id="sEeAq04" data-type="Theory" data-set="Set E" data-difficulty="Easy" data-topic="Forms of Business Organizations" data-answer="D" data-points="3">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Forms of Business Organizations</h2>
        <div class="book-content-question">A business organization that is owned by its members and operates for their mutual benefit is called a:</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sEeAq04', 'A')">A) Corporation</li>
            <li class="book-mcq-option" onclick="selectOption('sEeAq04', 'B')">B) Partnership</li>
...
<div class="slide" id="slide-sEeAq05" data-question-id="sEeAq05" data-type="Theory" data-set="Set E" data-difficulty="Easy" data-topic="Accounting Concepts and Principles" data-answer="C" data-points="3">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Accounting Concepts and Principles</h2>
        <div class="book-content-question">The concept that requires a business to be treated as a separate economic unit from its owners is the:</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sEeAq05', 'A')">A) Going concern principle</li>
            <li class="book-mcq-option" onclick="selectOption('sEeAq05', 'B')">B) Periodicity concept</li>
...
<div class="slide" id="slide-sEeAq06" data-question-id="sEeAq06" data-type="Theory" data-set="Set E" data-difficulty="Easy" data-topic="The Accounting Equation and Major Accounts" data-answer="C" data-points="3">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: The Accounting Equation and Major Accounts</h2>
        <div class="book-content-question">Which type of account represents the owner's residual interest in the assets of the business after deducting all liabilities?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sEeAq06', 'A')">A) Asset</li>
            <li class="book-mcq-option" onclick="selectOption('sEeAq06', 'B')">B) Liability</li>
...
<div class="slide" id="slide-sEeAq07" data-question-id="sEeAq07" data-type="Theory" data-set="Set E" data-difficulty="Easy" data-topic="Books of Accounts" data-answer="A" data-points="3">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Books of Accounts</h2>
        <div class="book-content-question">A subsidiary ledger is used to provide detailed information for a specific account in the general ledger. What is that general ledger account called?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sEeAq07', 'A')">A) Controlling account</li>
            <li class="book-mcq-option" onclick="selectOption('sEeAq07', 'B')">B) Contra account</li>
...
<div class="slide" id="slide-sAaVq01" data-question-id="sAaVq01" data-type="Theory" data-set="Set A" data-difficulty="Average" data-topic="Statement of Financial Position" data-answer="B" data-points="6">
    ...
    <div class="book-content">
        ...
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sAaVq01', 'A')">A) Alphabetical order</li>
            <li class="book-mcq-option" onclick="selectOption('sAaVq01', 'B')">B) Current and Non-current</li>
...
<div class="slide" id="slide-sAaVq02" data-question-id="sAaVq02" data-type="Theory" data-set="Set A" data-difficulty="Average" data-topic="Cash Flow Statement" data-answer="C" data-points="6">
    ...
    <div class="book-content">
        ...
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sAaVq02', 'A')">A) Increase in accounts receivable</li>
            <li class="book-mcq-option" onclick="selectOption('sAaVq02', 'B')">B) Decrease in accounts payable</li>
...
<div class="slide" id="slide-sAaVq03" data-question-id="sAaVq03" data-type="Theory" data-set="Set A" data-difficulty="Average" data-topic="Financial Statement Analysis" data-answer="C" data-points="6">
    ...
    <div class="book-content">
        ...
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sAaVq03', 'A')">A) Current Ratio</li>
            <li class="book-mcq-option" onclick="selectOption('sAaVq03', 'B')">B) Debt-to-Equity Ratio</li>
...
<div class="slide" id="slide-sAaVq04" data-question-id="sAaVq04" data-type="Theory" data-set="Set A" data-difficulty="Average" data-topic="Bank Reconciliation Statement" data-answer="B" data-points="6">
    ...
    <div class="book-content">
        ...
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sAaVq04', 'A')">A) Added to the bank statement balance</li>
            <li class="book-mcq-option" onclick="selectOption('sAaVq04', 'B')">B) Deducted from the bank statement balance</li>
...
<div class="slide" id="slide-sAaVq05" data-question-id="sAaVq05" data-type="Theory" data-set="Set A" data-difficulty="Average" data-topic="Income and Business Taxation" data-answer="C" data-points="6">
    ...
    <div class="book-content">
        ...
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sAaVq05', 'A')">A) Income Tax</li>
            <li class="book-mcq-option" onclick="selectOption('sAaVq05', 'B')">B) Excise Tax</li>
...
<div class="slide" id="slide-sDaVq01" data-question-id="sDaVq01" data-type="Theory" data-set="Set D" data-difficulty="Average" data-topic="Statement of Financial Position" data-answer="B" data-points="6">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Statement of Financial Position</h2>
        <div class="book-content-question">Which of the following items is properly classified as an intangible asset on the Statement of Financial Position?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sDaVq01', 'A')">A) Prepaid Rent</li>
            <li class="book-mcq-option" onclick="selectOption('sDaVq01', 'B')">B) Patents</li>
...
<div class="slide" id="slide-sDaVq02" data-question-id="sDaVq02" data-type="Theory" data-set="Set D" data-difficulty="Average" data-topic="Statement of Comprehensive Income" data-answer="C" data-points="6">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Statement of Comprehensive Income</h2>
        <div class="book-content-question">In a multi-step Statement of Comprehensive Income, how is "Freight-out" (delivery expense) classified?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sDaVq02', 'A')">A) Part of Cost of Goods Sold</li>
            <li class="book-mcq-option" onclick="selectOption('sDaVq02', 'B')">B) A deduction from Gross Sales</li>
...
<div class="slide" id="slide-sDaVq03" data-question-id="sDaVq03" data-type="Theory" data-set="Set D" data-difficulty="Average" data-topic="Statement of Changes in Equity" data-answer="C" data-points="6">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Statement of Changes in Equity</h2>
        <div class="book-content-question">How does a net loss for the reporting period affect the Statement of Changes in Equity for a sole proprietorship?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sDaVq03', 'A')">A) It increases the drawing account</li>
            <li class="book-mcq-option" onclick="selectOption('sDaVq03', 'B')">B) It has no effect on the ending equity</li>
...
<div class="slide" id="slide-sDaVq04" data-question-id="sDaVq04" data-type="Theory" data-set="Set D" data-difficulty="Average" data-topic="Bank Reconciliation Statement" data-answer="D" data-points="6">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Bank Reconciliation Statement</h2>
        <div class="book-content-question">When preparing a bank reconciliation, how is an NSF (Not Sufficient Funds) check returned by the bank handled?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sDaVq04', 'A')">A) Added to the bank balance</li>
            <li class="book-mcq-option" onclick="selectOption('sDaVq04', 'B')">B) Deducted from the bank balance</li>
...
<div class="slide" id="slide-sDaVq05" data-question-id="sDaVq05" data-type="Theory" data-set="Set D" data-difficulty="Average" data-topic="Income and Business Taxation" data-answer="B" data-points="6">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Income and Business Taxation</h2>
        <div class="book-content-question">Which of the following best describes "Gross Income" as defined by the Philippine Tax Code?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sDaVq05', 'A')">A) Total sales minus cost of sales and all operating expenses</li>
            <li class="book-mcq-option" onclick="selectOption('sDaVq05', 'B')">B) All income derived from whatever source, including compensation, business, and passive income</li>
...
<div class="slide" id="slide-sEaVq01" data-question-id="sEaVq01" data-type="Theory" data-set="Set E" data-difficulty="Average" data-topic="Statement of Financial Position" data-answer="A" data-points="6">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Statement of Financial Position</h2>
        <div class="book-content-question">Which of the following best describes the "report form" of the Statement of Financial Position?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sEaVq01', 'A')">A) Assets, liabilities, and equity are presented in a single continuous column downward.</li>
            <li class="book-mcq-option" onclick="selectOption('sEaVq01', 'B')">B) Assets are on the left side, and liabilities and equity are on the right side.</li>
...
<div class="slide" id="slide-sEaVq02" data-question-id="sEaVq02" data-type="Theory" data-set="Set E" data-difficulty="Average" data-topic="Statement of Comprehensive Income" data-answer="C" data-points="6">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Statement of Comprehensive Income</h2>
        <div class="book-content-question">In a service business, which of the following line items is NOT typically found on the Statement of Comprehensive Income?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sEaVq02', 'A')">A) Service Revenue</li>
            <li class="book-mcq-option" onclick="selectOption('sEaVq02', 'B')">B) Salaries Expense</li>
...
<div class="slide" id="slide-sEaVq03" data-question-id="sEaVq03" data-type="Theory" data-set="Set E" data-difficulty="Average" data-topic="Cash Flow Statement" data-answer="C" data-points="6">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Cash Flow Statement</h2>
        <div class="book-content-question">Under the statement of cash flows, payment of cash dividends to the business owners or shareholders is classified as what type of activity?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sEaVq03', 'A')">A) Operating Activity</li>
            <li class="book-mcq-option" onclick="selectOption('sEaVq03', 'B')">B) Investing Activity</li>
...
<div class="slide" id="slide-sEaVq04" data-question-id="sEaVq04" data-type="Theory" data-set="Set E" data-difficulty="Average" data-topic="Bank Reconciliation Statement" data-answer="B" data-points="6">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Bank Reconciliation Statement</h2>
        <div class="book-content-question">What is a "deposit in transit" in the context of a bank reconciliation?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sEaVq04', 'A')">A) A deposit recorded by the bank but not yet recorded by the company.</li>
            <li class="book-mcq-option" onclick="selectOption('sEaVq04', 'B')">B) A deposit recorded by the company but not yet processed by the bank.</li>
...
<div class="slide" id="slide-sEaVq05" data-question-id="sEaVq05" data-type="Theory" data-set="Set E" data-difficulty="Average" data-topic="Income and Business Taxation" data-answer="A" data-points="6">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Income and Business Taxation</h2>
        <div class="book-content-question">Which Bureau of Internal Revenue (BIR) form is used for filing the Annual Income Tax Return for Individuals earning purely compensation income?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sEaVq05', 'A')">A) BIR Form 1700</li>
            <li class="book-mcq-option" onclick="selectOption('sEaVq05', 'B')">B) BIR Form 1701</li>
...
<div class="slide" id="slide-sAdIq01" data-question-id="sAdIq01" data-type="Theory" data-set="Set A" data-difficulty="Difficult" data-topic="Statement of Financial Position" data-answer="B" data-points="9">
    ...
    <div class="book-content">
        ...
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sAdIq01', 'A')">A) Contingent Liabilities</li>
            <li class="book-mcq-option" onclick="selectOption('sAdIq01', 'B')">B) Biological Assets</li>
...
<div class="slide" id="slide-sAdIq02" data-question-id="sAdIq02" data-type="Theory" data-set="Set A" data-difficulty="Difficult" data-topic="Cash Flow Statement" data-answer="D" data-points="9">
    ...
    <div class="book-content">
        ...
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sAdIq02', 'A')">A) As an outflow from investing activities</li>
            <li class="book-mcq-option" onclick="selectOption('sAdIq02', 'B')">B) As an outflow from operating activities</li>
...
<div class="slide" id="slide-sAdIq03" data-question-id="sAdIq03" data-type="Theory" data-set="Set A" data-difficulty="Difficult" data-topic="Bank Reconciliation Statement" data-answer="C" data-points="9">
    ...
    <div class="book-content">
        ...
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sAdIq03', 'A')">A) Addition to the bank balance</li>
            <li class="book-mcq-option" onclick="selectOption('sAdIq03', 'B')">B) Deduction from the bank balance</li>
...
<div class="slide" id="slide-sDdIq01" data-question-id="sDdIq01" data-type="Theory" data-set="Set D" data-difficulty="Difficult" data-topic="Statement of Financial Position" data-answer="B" data-points="9">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Statement of Financial Position</h2>
        <div class="book-content-question">A short-term obligation is expected to be refinanced on a long-term basis. Under PAS 1, how is this obligation classified if the refinancing agreement is completed after the reporting period but before the financial statements are authorized for issue?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sDdIq01', 'A')">A) Non-current liability</li>
            <li class="book-mcq-option" onclick="selectOption('sDdIq01', 'B')">B) Current liability</li>
...
<div class="slide" id="slide-sDdIq02" data-question-id="sDdIq02" data-type="Theory" data-set="Set D" data-difficulty="Difficult" data-topic="Statement of Comprehensive Income" data-answer="C" data-points="9">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Statement of Comprehensive Income</h2>
        <div class="book-content-question">Which of the following items is recognized in Other Comprehensive Income (OCI) rather than in regular profit or loss?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sDdIq02', 'A')">A) Impairment loss on inventory</li>
            <li class="book-mcq-option" onclick="selectOption('sDdIq02', 'B')">B) Unrealized gain on trading securities</li>
...
<div class="slide" id="slide-sDdIq03" data-question-id="sDdIq03" data-type="Theory" data-set="Set D" data-difficulty="Difficult" data-topic="Income and Business Taxation" data-answer="B" data-points="9">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Income and Business Taxation</h2>
        <div class="book-content-question">Under the Philippine Tax Code, what is the final capital gains tax rate applied to the net capital gain from the sale of unlisted domestic shares of stock by a resident citizen?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sDdIq03', 'A')">A) 6%</li>
            <li class="book-mcq-option" onclick="selectOption('sDdIq03', 'B')">B) 15%</li>
...
<div class="slide" id="slide-sEdIq01" data-question-id="sEdIq01" data-type="Theory" data-set="Set E" data-difficulty="Difficult" data-topic="Bank Reconciliation Statement" data-answer="C" data-points="9">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Bank Reconciliation Statement</h2>
        <div class="book-content-question">How should a bank error involving the bank crediting the company's account for a deposit made by another entirely different company be treated on the bank reconciliation?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sEdIq01', 'A')">A) Deducted from the book balance</li>
            <li class="book-mcq-option" onclick="selectOption('sEdIq01', 'B')">B) Added to the book balance</li>
...
<div class="slide" id="slide-sEdIq02" data-question-id="sEdIq02" data-type="Theory" data-set="Set E" data-difficulty="Difficult" data-topic="Income and Business Taxation" data-answer="D" data-points="9">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Income and Business Taxation</h2>
        <div class="book-content-question">For a domestic corporation, what is the proper tax treatment of dividend income received from a foreign corporation, assuming the strict conditions for the dividend exemption under the CREATE Law are NOT met?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sEdIq02', 'A')">A) Subject to 20% final withholding tax</li>
            <li class="book-mcq-option" onclick="selectOption('sEdIq02', 'B')">B) Subject to 15% final withholding tax</li>
...
<div class="slide" id="slide-sEdIq03" data-question-id="sEdIq03" data-type="Theory" data-set="Set E" data-difficulty="Difficult" data-topic="Financial Statement Analysis" data-answer="B" data-points="9">
    ...
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Financial Statement Analysis</h2>
        <div class="book-content-question">A company has a very high inventory turnover ratio but an extremely low current ratio. What does this combination most likely indicate?</div>
        <ul style="list-style: none; padding: 0;">
            <li class="book-mcq-option" onclick="selectOption('sEdIq03', 'A')">A) The company is highly liquid and holding excess cash.</li>
            <li class="book-mcq-option" onclick="selectOption('sEdIq03', 'B')">B) The company sells its inventory quickly but may struggle to pay short-term obligations.</li>
...
<div class="slide" id="slide-sEdIq04" data-question-id="sEdIq04" data-type="Problem Solving" data-set="Set E" data-difficulty="Difficult" data-topic="Statement of Financial Position" data-answer="770000" data-points="9">
    <div class="quiz-container">
        <div class="topic-text">Topic: Statement of Financial Position</div>
        <div class="question-text">The trial balance of a firm shows the following: Accounts Receivable ₱800,000; Allowance for Doubtful Accounts ₱30,000; Advances to Employees ₱45,000; Advances from Customers (Unearned Revenue) ₱60,000. What is the net realizable value of the trade receivables? (Enter numbers only)</div>
        <input type="number" class="input-field" id="input-sEdIq04" placeholder="Enter numerical amount...">
        <button class="submit-btn" id="submit-sEdIq04" onclick="submitAnswer('sEdIq04')">Submit Answer</button>
        <button class="exp-btn" id="exp-sEdIq04" onclick="toggleBookMode()">Show Explanation</button>
        <div class="quiz-feedback" id="feedback-sEdIq04"></div>
    </div>
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Statement of Financial Position</h2>
...
<div class="slide" id="slide-sEdIq05" data-question-id="sEdIq05" data-type="Problem Solving" data-set="Set E" data-difficulty="Difficult" data-topic="Statement of Comprehensive Income" data-answer="3760000" data-points="9">
    <div class="quiz-container">
        <div class="topic-text">Topic: Statement of Comprehensive Income</div>
        <div class="question-text">An entity reported gross sales of ₱5,000,000, sales discounts of ₱100,000, and sales returns of ₱200,000. The gross profit rate based on cost is 25%. What is the cost of goods sold? (Enter numbers only)</div>
        <input type="number" class="input-field" id="input-sEdIq05" placeholder="Enter numerical amount...">
        <button class="submit-btn" id="submit-sEdIq05" onclick="submitAnswer('sEdIq05')">Submit Answer</button>
        <button class="exp-btn" id="exp-sEdIq05" onclick="toggleBookMode()">Show Explanation</button>
        <div class="quiz-feedback" id="feedback-sEdIq05"></div>
    </div>
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Statement of Comprehensive Income</h2>
...
<div class="slide" id="slide-sEdIq06" data-question-id="sEdIq06" data-type="Problem Solving" data-set="Set E" data-difficulty="Difficult" data-topic="Statement of Changes in Equity" data-answer="300000" data-points="9">
    <div class="quiz-container">
        <div class="topic-text">Topic: Statement of Changes in Equity</div>
        <div class="question-text">An entity's total assets decreased by ₱300,000 and total liabilities decreased by ₱500,000 during the year. The owner made personal withdrawals of ₱150,000 and invested an additional ₱50,000. What is the net income for the year? (Enter numbers only)</div>
        <input type="number" class="input-field" id="input-sEdIq06" placeholder="Enter numerical amount...">
        <button class="submit-btn" id="submit-sEdIq06" onclick="submitAnswer('sEdIq06')">Submit Answer</button>
        <button class="exp-btn" id="exp-sEdIq06" onclick="toggleBookMode()">Show Explanation</button>
        <div class="quiz-feedback" id="feedback-sEdIq06"></div>
    </div>
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Statement of Changes in Equity</h2>
...
<div class="slide" id="slide-sEdIq07" data-question-id="sEdIq07" data-type="Problem Solving" data-set="Set E" data-difficulty="Difficult" data-topic="Cash Flow Statement" data-answer="-280000" data-points="9">
    <div class="quiz-container">
        <div class="topic-text">Topic: Cash Flow Statement</div>
        <div class="question-text">A company sold a piece of equipment for ₱120,000 cash, recognizing a gain of ₱30,000. The company also purchased new equipment for ₱400,000 cash and paid ₱50,000 in cash dividends to shareholders. What is the net cash flow from investing activities? (Enter as a negative number if it is a net outflow, e.g., -10000)</div>
        <input type="number" class="input-field" id="input-sEdIq07" placeholder="Enter numerical value...">
        <button class="submit-btn" id="submit-sEdIq07" onclick="submitAnswer('sEdIq07')">Submit Answer</button>
        <button class="exp-btn" id="exp-sEdIq07" onclick="toggleBookMode()">Show Explanation</button>
        <div class="quiz-feedback" id="feedback-sEdIq07"></div>
    </div>
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Cash Flow Statement</h2>
...
<div class="slide" id="slide-sEdIq08" data-question-id="sEdIq08" data-type="Problem Solving" data-set="Set E" data-difficulty="Difficult" data-topic="Bank Reconciliation Statement" data-answer="708000" data-points="9">
    <div class="quiz-container">
        <div class="topic-text">Topic: Bank Reconciliation Statement</div>
        <div class="question-text">The unadjusted book balance is ₱650,000. During reconciliation, you noted: Bank service charge of ₱3,000; Customer's NSF check of ₱12,000; Note collected by the bank of ₱55,000; and a check for ₱24,000 issued for office equipment was erroneously recorded by the bookkeeper as ₱42,000. What is the adjusted book balance? (Enter numbers only)</div>
        <input type="number" class="input-field" id="input-sEdIq08" placeholder="Enter numerical amount...">
        <button class="submit-btn" id="submit-sEdIq08" onclick="submitAnswer('sEdIq08')">Submit Answer</button>
        <button class="exp-btn" id="exp-sEdIq08" onclick="toggleBookMode()">Show Explanation</button>
        <div class="quiz-feedback" id="feedback-sEdIq08"></div>
    </div>
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Bank Reconciliation Statement</h2>
...
<div class="slide" id="slide-sEdIq09" data-question-id="sEdIq09" data-type="Problem Solving" data-set="Set E" data-difficulty="Difficult" data-topic="Income and Business Taxation" data-answer="84000" data-points="9">
    <div class="quiz-container">
        <div class="topic-text">Topic: Income and Business Taxation</div>
        <div class="question-text">A VAT-registered taxpayer has the following data for the month (amounts are exclusive of VAT): Sales ₱1,500,000; Purchases of goods from VAT-registered suppliers ₱800,000; Purchases of services from Non-VAT suppliers ₱100,000. What is the VAT payable for the month? (Enter numbers only)</div>
        <input type="number" class="input-field" id="input-sEdIq09" placeholder="Enter numerical amount...">
        <button class="submit-btn" id="submit-sEdIq09" onclick="submitAnswer('sEdIq09')">Submit Answer</button>
        <button class="exp-btn" id="exp-sEdIq09" onclick="toggleBookMode()">Show Explanation</button>
        <div class="quiz-feedback" id="feedback-sEdIq09"></div>
    </div>
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Income and Business Taxation</h2>
...
<div class="slide" id="slide-sEdIq10" data-question-id="sEdIq10" data-type="Problem Solving" data-set="Set E" data-difficulty="Difficult" data-topic="Financial Statement Analysis" data-answer="3.6" data-points="9">
    <div class="quiz-container">
        <div class="topic-text">Topic: Financial Statement Analysis</div>
        <div class="question-text">A company has an average inventory of ₱500,000 and a gross profit of ₱1,200,000. If the gross profit margin based on sales is 40%, what is the inventory turnover ratio? (Enter the exact decimal number only, e.g., if 2.5, enter 2.5)</div>
        <input type="number" step="0.1" class="input-field" id="input-sEdIq10" placeholder="Enter numerical value...">
        <button class="submit-btn" id="submit-sEdIq10" onclick="submitAnswer('sEdIq10')">Submit Answer</button>
        <button class="exp-btn" id="exp-sEdIq10" onclick="toggleBookMode()">Show Explanation</button>
        <div class="quiz-feedback" id="feedback-sEdIq10"></div>
    </div>
    <div class="book-content">
        <button class="back-quiz-btn" onclick="toggleBookMode()">← Back to Quiz</button>
        <h2>Explanation: Financial Statement Analysis</h2>

        ...
        for(let i = 0; i < maxRows; i++) {
            ...
            if(solBody[i]) {
                ...
                if (expAmt !== '') {
                    ...
                    // Auto-pass if no amount was expected (e.g. for Headers)
                    amtCorr = true; 
                }
            }

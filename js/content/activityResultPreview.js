                                            ...
                                            if (!hasMath) {
                                                ...
                                                for (let i = 0; i < tokens.length; i++) {
                                                    ...
                                                    if (['+', '-', '*', '/', '='].includes(t)) {
                                                        ...
                                                        // 4. Capture Descriptions, amounts, and trailing units/words/currencies
                                                    ...
                                                    <div key=${sIdx} className="w-full font-mono text-sm ml-0 mb-1 bg-white mt-1">
                                                        ${lines.map((line) => {
                                                            ...
                                                            if (line.borderClass && line.borderClass.includes('border-double')) {
                                                                descClass = descClass.replace('text-gray-700', 'text-black').replace('text-red-600', 'text-black') + "pb-4 font-bold";
                                                                amtClass = amtClass.replace('text-gray-800', 'text-black').replace('text-red-600', 'text-black') + "pb-4 font-bold";
                                                            }
